      ...
      <section className="container mx-auto px-4 pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
            Swap, Share, <span className="text-emerald-600 dark:text-emerald-400">Sustain</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 text-white px-8 py-3 text-lg">
              <Link to="/register" className="flex items-center gap-2">
                Start Swapping <ArrowRight className="h-5 w-5" />
              </Link>
            </Button>
            <Button variant="outline" size="lg" className="border-emerald-600 text-emerald-600 dark:border-emerald-400 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 px-8 py-3 text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-white">Eco-Friendly</h3>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold mb-3 dark:text-white">Points System</h3>
                <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="bg-emerald-600 dark:bg-emerald-700 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" variant="secondary" className="bg-white text-emerald-600 hover:bg-gray-100 dark:bg-gray-100 dark:text-emerald-700 dark:hover:bg-gray-200">
              <Link to="/add-item">List an Item</Link>
            </Button>
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-emerald-700 dark:hover:bg-emerald-600">
